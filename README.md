...
Модули
-----
### Модули машинной обработки

Номер модуля | Название файла | Описание
---|---|---
A1 | parse.py | Разбор текста на слова и знаки, установка связи и подчинений, устанавливается роль каждого слова.
A2 | style.py | Определения стиля текста, настроения, главной темы, тип, уровень цензуры.
A3 | treatment.py | Обработка текста нейронными сетями: сокращение, обобщение. 
A4 | literacy.py | Проверка грамотности и логичности. Изменение логических связей между словами. Восстановление форм слов.
A5 | add.py | Дополнение информацией из других источников.

### Модули обработки алгоритмами

Номер модуля | Название файла | Описание
---|---|---
B1 | excess.py | Замена фразеологизмов, повторений.
...
Номер модуля | Название файла | Описание
---|---|---
C1 | format.py | Преобразование текстов в форматированный вид для машинного обучения.
C2 | training.py | Обучение нейронной сети на базе текстов.
